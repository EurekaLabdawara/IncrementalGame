...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        //Fungsi untuk selalu mengeksekusi CollectPerSecond setiap detik (dengan menggunakan fungsi Time.unscaledDeltaTime)
    ...
    private void CollectPerSecond()
    {
        ...
        //Fungsi ToString("F1") adalah untuk membulatkan angka menjadi desimal yang memiliki 1 angka di belakang koma
...
//Fungsi System.Serializable digunakan supaya object bisa di-serialize dan value dapat di-set di inspector
[System.Serializable]
